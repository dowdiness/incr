...
| [2026-06-01](decisions/2026-06-01-static-derived-public-surface.md) | Static Derived public surface: keep the measured static/applicative fast path package-private. `Derived::map` was later added as an ordinary dynamic convenience (#756); static `map2`/`map3`, `Scope::derived_static*`, compatibility conveniences, and raw installers remain closed until a concrete driver appears. |
