...
`dowdiness/incr_next`; K1.1–K1.4 accepted and merged, K1.5 implementation
complete and maintainer accepted with merge pending, and K1.6 blocked and
uncommissioned):
...
- [Incr Next module roadmap](../incr_next/docs/roadmap.md) — accepted and merged K1.1–K1.4, maintainer-accepted K1.5 with merge pending, and blocked K1.6
...
- [Incr Next K1.5 validation](../incr_next/docs/k1-5-validation.md) — accepted private proof loss, rematerialization, cleanup, ownership, hosted acceptance, and merge-pending evidence
