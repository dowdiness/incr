...
5. [Checked Cookbook Examples](cookbook_examples.mbt.md) — literate tests for high-value cookbook patterns, including target facades, sparse presence anchors, long-lived authoring pipelines, scoped watches, accumulators, and memo events
...
- [Checked Cookbook Examples](cookbook_examples.mbt.md) — companion literate tests pinning high-value cookbook patterns, including target facades, sparse presence anchors, long-lived authoring pipelines, scoped watches, accumulators, and memo events
