...
|---|---|---:|---:|---|---|
| 015 | Incr Next kernel alpha | P1 | L | K0 merged in PR #470 | IN PROGRESS (K1.1–K1.4 ACCEPTED / MERGED; K1.5 IMPLEMENTATION COMPLETE / MAINTAINER ACCEPTED / MERGE PENDING; K1.6 BLOCKED / UNCOMMISSIONED) |
