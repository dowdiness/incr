...
`dowdiness/incr_next`; K1.1 and K1.2 accepted and merged, K1.3 commissioned,
and K1.4–K1.6 blocked and uncommissioned):
...
- [Incr Next module roadmap](../incr_next/docs/roadmap.md) — accepted K1.1/K1.2 surfaces, commissioned K1.3, and blocked later stages
