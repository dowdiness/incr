...
- [2026-06-05 `CommittedDerived`](design/specs/2026-06-05-committed-derived.md) — proposed success-gated authoring primitive that exposes current fallible candidates while retaining the last committed semantic value
