...
|---|---|---:|---:|---|---|
| 015 | Incr Next kernel alpha | P1 | L | K0 merged in PR #470 | IN PROGRESS (K1.1 ACCEPTED / MERGED; K1.2 ACCEPTED / MERGED; K1.3 IMPLEMENTATION COMPLETE / MAINTAINER ACCEPTED / MERGE PENDING; K1.4–K1.6 BLOCKED / UNCOMMISSIONED) |
