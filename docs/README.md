...
`dowdiness/incr_next`; K1.1–K1.4 accepted and merged, K1.5 commissioned with
implementation not accepted, and K1.6 blocked and uncommissioned):
...
- [Incr Next module roadmap](../incr_next/docs/roadmap.md) — accepted and merged K1.1–K1.4, commissioned K1.5, and blocked K1.6
