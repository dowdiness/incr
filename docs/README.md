...
`dowdiness/incr_next`; K1.1 and K1.2 accepted, and K1.3–K1.6 blocked and
uncommissioned):
...
- [Incr Next module roadmap](../incr_next/docs/roadmap.md) — accepted K1.1 and K1.2 surfaces, and blocked later stages
