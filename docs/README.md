...
- [Retention ownership native-RC probe](../examples/spikes/ownership_native_rc/README.md) — multi-instance native finalizer evidence for the V12.4 ownership verdict
