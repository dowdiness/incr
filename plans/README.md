...
|---|---|---:|---:|---|---|
| [013](013-typed-spreadsheet-egw-boundary-experiment.md) | Run the typed-spreadsheet EGW boundary experiment | P1 | L | Published EGW 0.4.0 | IN PROGRESS (Phase 1 complete; Phase 2 unstarted) |
...
API verification passed 2026-07-20; Phase 1 (domain package promotion) passed
2026-07-20; Phase 2 (pure adapter core) is next and unstarted.
...
- Plan 012 shipped in [PR #421](https://github.com/dowdiness/incr/pull/421),
  ...
  variant-implied preconditions; `UiEffect` is focus-only; AI publication
  remains unconditional. Public `incr_tea`, `incr`, `typed_spreadsheet`, and
  EGW APIs are unchanged. The future application-specific EGW adapter and
  formula policy remain separate; issue
  [dowdiness/event-graph-walker#72](https://github.com/dowdiness/event-graph-walker/issues/72)
  remains driver-gated; no generic `egw_incr` bridge. No ADR needed: this is an
  application-local unpublished pilot.
