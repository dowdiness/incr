...
`dowdiness/incr_next`; K1.1 accepted, K1.2 implementation complete with a
passing local gate but not accepted, and K1.3–K1.6 blocked and uncommissioned):
...
- [Incr Next module roadmap](../incr_next/docs/roadmap.md) — accepted K1.1 surface, locally complete but unaccepted K1.2 scope, and blocked later stages
...
- [Incr Next K1.2 local validation](../incr_next/docs/k1-2-validation.md) — local semantics, ownership, interface, backend, and work-count evidence; implementation not accepted
