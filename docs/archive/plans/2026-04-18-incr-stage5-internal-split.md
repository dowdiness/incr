...
**Authoritative spec:** [`docs/design/specs/2026-04-18-incr-stage5-internal-split-design.md`](../../design/specs/2026-04-18-incr-stage5-internal-split-design.md). If this plan and the spec ever disagree, **the spec wins** — file a follow-up to update the plan.
